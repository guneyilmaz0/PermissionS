package net.guneyilmaz0.permissionss.group;
...
public class GroupManager {
    ...
    public static Process addGroup(String groupName) {
        if (Utils.isInvalidGroupName(groupName)) return Process.INVALID_NAME;
        else if (getGroup(groupName) != null) return Process.ALREADY_EXISTS;
    ...
    public static Process removeGroup(String groupName) {
        if (Utils.isInvalidGroupName(groupName)) return Process.INVALID_NAME;
        else if (getGroup(groupName) == null) return Process.NOT_FOUND;
